        ...
        <section id="about" className="about">
            ...
            <div className="about-container">
                ...
                <div className="description-container">
                    <p>
                        Hey there! I'm Minh, a frontend developer from Seattle, specializing in JavaScript, React, and Next.js. Graduating with honors from the University of Washington in Informatics, I've led projects that significantly improved user experiences and operational efficiencies.
                    </p>
                    <p>
                ...
                <div className="skills-container">
                    <div className="icon react-icon">
                        <svg viewBox="0 0 128 128" className="floating">
